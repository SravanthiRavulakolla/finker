...
import { Checkbox } from "@/components/ui/checkbox"; // Correct import from shadcn/ui
...
const{
  ...
  },[TransactionStatus, searchTerm, typeFilter, recurringFilter, sortConfig]);
                  ...
                  <TableRow key={transaction.id}>
                    ...
                    <TableCell>
                      {transaction.isRecurring ? (
                        <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger>
                              <Badge variant="outline" className="gap-1 bg-purple-700 hover:bg-purple-200">
                                <RefreshCw className="h-3 w-3" />
                                {RECURRING_INTERVALS[transaction.recurringInterval]}
                              </Badge>
                            </TooltipTrigger>
                            <TooltipContent className="bg-black text-white z-50 rounded-md px-2 py-1 shadow-lg">
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent className="bg-black text-white z-50">
